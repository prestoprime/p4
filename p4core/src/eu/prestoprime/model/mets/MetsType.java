...
@XmlType(name = "metsType", propOrder = { "metsHdr", "dmdSec", "amdSec", "fileSec", "structMap", "structLink", "behaviorSec" })
@XmlSeeAlso({ Mets.class })
public class MetsType implements Serializable {
	...
	public static class FileSec implements Serializable {
		...
		@XmlAccessorType(XmlAccessType.FIELD)
		@XmlType(name = "")
		public static class FileGrp extends FileGrpType implements Serializable {
	...
	public static class MetsHdr implements Serializable {
		...
		public static class AltRecordID implements Serializable {
		...
		@XmlAccessorType(XmlAccessType.FIELD)
		@XmlType(name = "", propOrder = { "value" })
		public static class MetsDocumentID implements Serializable {
	...
	@XmlAccessorType(XmlAccessType.FIELD)
	@XmlType(name = "")
	public static class StructLink extends StructLinkType implements Serializable {
