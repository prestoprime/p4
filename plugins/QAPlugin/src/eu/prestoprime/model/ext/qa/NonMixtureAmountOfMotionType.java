...
/**
 * <p>
 * Java class for NonMixtureAmountOfMotionType complex type.
 * 
 * <p>
 ...
 *       &lt;choice>
 *         &lt;element name="TrackLeft" type="{urn:mpeg:mpeg7:schema:2004}unsigned11"/>
 *         &lt;element name="TrackRight" type="{urn:mpeg:mpeg7:schema:2004}unsigned11"/>
 *         &lt;element name="BoomDown" type="{urn:mpeg:mpeg7:schema:2004}unsigned11"/>
 *         &lt;element name="BoomUp" type="{urn:mpeg:mpeg7:schema:2004}unsigned11"/>
 *         &lt;element name="DollyForward" type="{urn:mpeg:mpeg7:schema:2004}unsigned11"/>
 *         &lt;element name="DollyBackward" type="{urn:mpeg:mpeg7:schema:2004}unsigned11"/>
 *         &lt;element name="PanLeft" type="{urn:mpeg:mpeg7:schema:2004}unsigned11"/>
 *         &lt;element name="PanRight" type="{urn:mpeg:mpeg7:schema:2004}unsigned11"/>
 *         &lt;element name="TiltDown" type="{urn:mpeg:mpeg7:schema:2004}unsigned11"/>
 *         &lt;element name="TiltUp" type="{urn:mpeg:mpeg7:schema:2004}unsigned11"/>
 *         &lt;element name="RollClockwise" type="{urn:mpeg:mpeg7:schema:2004}unsigned11"/>
 *         &lt;element name="RollAnticlockwise" type="{urn:mpeg:mpeg7:schema:2004}unsigned11"/>
 *         &lt;element name="ZoomIn" type="{urn:mpeg:mpeg7:schema:2004}unsigned11"/>
 *         &lt;element name="ZoomOut" type="{urn:mpeg:mpeg7:schema:2004}unsigned11"/>
 *         &lt;element name="Fixed">
 *           &lt;complexType>
 *             &lt;complexContent>
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
...
@XmlType(name = "NonMixtureAmountOfMotionType", propOrder = { "trackLeft", "trackRight", "boomDown", "boomUp", "dollyForward", "dollyBackward", "panLeft", "panRight", "tiltDown", "tiltUp", "rollClockwise", "rollAnticlockwise", "zoomIn", "zoomOut", "fixed" })
public class NonMixtureAmountOfMotionType implements Serializable {
	...
	protected NonMixtureAmountOfMotionType.Fixed fixed;
	 ...
	 * 
	 * @return possible object is {@link NonMixtureAmountOfMotionType.Fixed }
	 * 
	 */
	public NonMixtureAmountOfMotionType.Fixed getFixed() {
		return fixed;
	}
	 ...
	 * 
	 * @param value
	 *            allowed object is {@link NonMixtureAmountOfMotionType.Fixed }
	 * 
	 */
	public void setFixed(NonMixtureAmountOfMotionType.Fixed value) {
		this.fixed = value;
	}
