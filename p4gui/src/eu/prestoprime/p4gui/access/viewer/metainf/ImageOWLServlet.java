...
@WebServlet("/access/viewer/metainf/5")
public class ImageOWLServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String graphPath = AccessConnection.getGraphPath(user.getCurrentP4Service(), id);

		request.setAttribute("graph_path", graphPath);

		Tools.servletInclude(this, request, response, "/body/access/viewer/metainf/rights/viewImageOWL.jsp");
	}
}
