...
@WebServlet("/access/viewer/metainf/2")
public class FileSectionServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Tools.servletInclude(this, request, response, "/body/access/viewer/metainf/filesec/viewFilesec.jsp");
	}
}
