...
@WebServlet("/access/viewer/metainf/3")
public class EmbeddedSourceServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String source = AccessConnection.getDIP(user.getCurrentP4Service(), id).getContentAsString(false);

		request.setAttribute("source", source);

		Tools.servletInclude(this, request, response, "/body/access/viewer/metainf/source/viewEmbeddedSource.jsp");
	}
}
