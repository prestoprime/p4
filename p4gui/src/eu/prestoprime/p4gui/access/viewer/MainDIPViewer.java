...
@WebServlet("/access/viewer")
public class MainDIPViewer extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			List<Frame> frames = AccessConnection.getFrames(user.getCurrentP4Service(), id);
			request.setAttribute("frames", frames);
		} catch (Exception e) {
			e.printStackTrace();
		}

		Tools.servletInclude(this, request, response, "?_b=body/access/viewer/viewer.jsp");
	}
}
